...
<div class="row">
  <div class="col-xl-9 col-lg-9">
        ...
        <div class="card shadow mb-2 card-body">
          <div class="row">
            <div class="col-md-2"><input value="{{$val->view}}" name="name" placeholder="STT" type="text" class="form-control"></div>
            <div class="col-md-3"><input value="{{$val->name}}" name="name" placeholder="Tab" type="text" class="form-control"></div>
            <div class="col-md-7"><input value="{{$val->content}}" name="name" placeholder="Header" type="text" class="form-control"></div>
          </div>
          <textarea rows="4" name="content:" class="form-control" id="ckeditor{{$key+1}}"></textarea>
        </div>
        @endforeach
